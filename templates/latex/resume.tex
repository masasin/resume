...
~< else >~
  ...
  \usepackage{xeCJK}
  \setCJKmainfont[BoldFont=Noto Serif CJK JP Bold]{Noto Serif CJK JP Medium}
  \setCJKsansfont[BoldFont=Noto Sans CJK JP Bold]{Noto Serif CJK JP Medium}
...
\makeatletter
\let\@extrainfo\relax       % Remove extra info from letter
\makeatother
